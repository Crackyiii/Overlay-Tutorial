bool overlay_class::installImGui( )
{
	...
	window.WHandle = CreateWindowEx( WS_EX_TOPMOST | WS_EX_LAYERED | WS_EX_TRANSPARENT, L"Fortnite", L"Fortnite", WS_POPUP, 0, 0, window.ScreenWidth, window.ScreenHeight, NULL, NULL, GetModuleHandle(NULL), NULL);
